...
export function initPersonalWizard(){
 ...
 actions.insertAdjacentHTML('afterbegin','<button type="button" class="btn" data-wizard="back">Back</button><button type="button" class="btn primary" data-wizard="next">Next <svg class="arrow-icon" viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" role="img" aria-label="Next"><path d="M4 12h16m-6-6 6 6-6 6"/></svg></button>');
 let step=0;
